...
testsT1 =
  test
    ...
    , "Tarefa 1 - Teste Valida Mapa com uma porta flutuante"~: validaPotencialMapa [(Bloco,(0,3)),(Bloco,(3,3)),(Bloco,(1,3)),(Caixa,(0,1)),(Bloco,(2,3)),(Porta,(2,0)),(Bloco,(0,2)),(Bloco,(3,2))] ~=?  False
    ]
