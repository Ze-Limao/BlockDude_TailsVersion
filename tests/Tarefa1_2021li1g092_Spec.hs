...
testsT1 =
  test
    [ "Tarefa 1 - Teste Valida Mapa quando há caixas a flutuar" ~: validaPotencialMapa [(Porta, (0, 3)),(Bloco, (0, 4)),(Bloco, (1, 4)),(Bloco, (2, 4)),(Bloco, (3, 4)),(Bloco, (4, 4)),(Caixa, (4,2)),(Bloco, (5, 4)),(Bloco, (6, 4)),(Bloco, (6, 3)),(Bloco, (6, 2)),(Bloco, (6, 1))] ~=? False
    ...
    , "Tarefa 1 - Teste Valida Mapa sem espaços livres"~: validaPotencialMapa [(Bloco,(0,2)),(Caixa,(2,1)),(Bloco,(0,1)),(Bloco,(2,0)),(Bloco,(2,2)),(Porta,(1,0)),(Bloco,(1,2)),(Caixa,(0,0)),(Bloco,(1,1))] ~=?  False
    , "Tarefa 1 - Teste Valida Mapa com buracos"~: validaPotencialMapa [(Porta, (0, 3)),(Bloco, (0, 4)),(Bloco, (1, 4)),(Bloco, (3, 4)),(Bloco, (4, 4)),(Caixa, (4, 3)),(Bloco, (5, 4)),(Bloco, (6, 4)),(Bloco, (6, 3)),(Bloco, (6, 2)),(Bloco, (6, 1))] ~=?  False
    ]
