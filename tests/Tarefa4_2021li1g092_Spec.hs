...
testsT4 =
  test
    ...
    , "Tarefa 4 - Teste move m1e1 Este e queda no Vazio" ~: Jogo m1r (Jogador (6, 0) Este False) ~=?  moveJogador m1e1 AndarDireita
    ...
    , "Tarefa 4 - Teste moves esquerda e InterageCaixa" ~: m1e2 ~=?  correrMovimentos m1e1 [AndarEsquerda,InterageCaixa, InterageCaixa, Trepar, AndarEsquerda, AndarEsquerda]    
