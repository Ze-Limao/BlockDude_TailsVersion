...
testsT2 =
  test
    ...
    , "Tarefa 2 - Teste Desconstruir Mapa ter duas linhas vazias" ~: [[Vazio,Vazio,Vazio,Vazio,Vazio],[Vazio,Vazio,Vazio,Vazio,Vazio],[Bloco,Vazio,Vazio,Vazio,Bloco],[Bloco,Porta,Caixa,Vazio,Bloco],[Bloco,Bloco,Bloco,Bloco,Bloco]] ~=? desconstroiMapa [(Bloco,(0,2)),(Bloco,(4,2)),(Bloco,(0,3)),(Porta,(1,3)),(Caixa,(2,3)),(Bloco,(4,3)),(Bloco,(0,4)),(Bloco,(1,4)),(Bloco,(2,4)),(Bloco,(3,4)),(Bloco,(4,4))]
    ]