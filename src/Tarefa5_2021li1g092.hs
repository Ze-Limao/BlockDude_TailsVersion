...
desenhaEstadoGloss e@((Jogo mapa (Jogador (x,y) dir caixa)),(p1,p2,p3,p4,p5,p6,p7)) = Pictures(desenhar (desconstroiMapa mapa) e)

desenhar :: [(Peca,Coordenadas)] -> Estado -> [Picture]
desenhar ((h,(a,b)):t) e = desenharJ e ++ desenharM e ((h,(a,b)):t)
...
desenharJ ((Jogo mapa (Jogador (x,y) dir True)),(p1,p2,p3,p4,p5,p6,p7)) = 
    if  dir == Este then [Translate (int2Float(x * 60)) (int2Float ((-y * 50))) p6 ] 
                    else [Translate (int2Float(x * 60)) (int2Float ((-y * 50))) p7 ] 
...
main = do 
    ...
    Just p6 <- loadJuicy "tails_o_carregador_de_caixas_direita.png"  --atualizar imagem
    Just p7 <- loadJuicy "tails_o_carregador_de_caixas_esquerda.png"
    play 
      dm                                        -- janela onde irá correr o jogo
      azure                                     -- cor do fundo da janela
      60                                        -- frame rate
      (estadoGlossInicial jogo1 p1 p2 p3 p4 p5 p6 p7) -- estado inicial
...
jogo2 = (Jogo [[Vazio,Bloco],[Vazio,Bloco,Vazio,Vazio,Vazio,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco],[Bloco,Vazio,Bloco,Vazio,Bloco,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Bloco],[Bloco,Vazio,Vazio,Bloco,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Bloco],[Bloco,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Caixa,Bloco],[Bloco,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Caixa,Caixa,Bloco],[Bloco,Vazio,Bloco,Bloco,Bloco,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Vazio,Bloco,Caixa,Vazio,Bloco,Bloco],[Bloco,Vazio,Bloco,Vazio,Bloco,Vazio,Vazio,Vazio,Vazio,Bloco,Vazio,Vazio,Bloco,Bloco,Bloco,Bloco,Bloco],[Bloco,Vazio,Bloco,Vazio,Bloco,Caixa,Caixa,Vazio,Bloco,Bloco,Vazio,Vazio,Bloco],[Bloco,Porta,Bloco,Vazio,Bloco,Bloco,Bloco,Bloco,Bloco,Bloco,Vazio,Bloco,Bloco],[Bloco,Bloco,Bloco,Vazio,Bloco,Bloco,Vazio,Vazio,Vazio,Bloco,Bloco,Bloco]](Jogador (2,3) Oeste False))